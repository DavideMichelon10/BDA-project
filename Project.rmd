...
Separate model:
$\begin{align*} y \sim {\sf Beta}(\mu,\Phi) \\ logit(\mu_{dcs}) = \beta_{d} + \beta_{ds} + \beta_{c} + \beta_{cs} \\ \beta_{d} \sim {\mathcal N}(0,10) \\ \beta_{ds} \sim {\mathcal N}(0,10) \\ \beta_{c} \sim {\mathcal N}(0,10) \\ \beta_{cs} \sim {\mathcal N}(0,10) \end{align*}$
