...
kable(ess_basic, col.names = c("Parameter", "ESS_bulk","ESS_tail"), escape = F, caption = "Basic Model") %>%
...
```{r}
ess_year <- data.frame(Parameter = c("rider_name", "rider_name:year","team_name", "team_name:year"), 
                 ESS_bulk = c(ess_bulk(sd_r_n), ess_bulk(sd_r_n_y), ess_bulk(sd_t_n), ess_bulk(sd_t_n_y)),
                 ESS_tail = c(ess_tail(sd_r_n), ess_tail(sd_r_n_y), ess_tail(sd_t_n), ess_tail(sd_t_n_y)))
kable(ess_year, col.names = c("Parameter", "ESS_bulk", "ESS_tail"), escape = F, caption = "Yearly Model") %>%
                    kable_styling(latex_options = "hold_position")
```
